...
function search() {
    ...
    let author = searchTerms[0].trim();
    let story = searchTerms[1].trim();

// قم بتنفيذ منطق البحث هنا بناءً على المؤلف والقص

    document.getElementById("searchResults").innerHTML = `Author: ${author}, Story: ${story}`;
}
